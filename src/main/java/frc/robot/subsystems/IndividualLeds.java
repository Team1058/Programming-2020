...
public class IndividualLeds{
    ...
    public void scrollNColorsWithBackround(int r, int g, int b, int r1, int g1, int b1,
                                           int r2, int g2, int b2, int n, int x, int y) {
    ledCounter = getN(1);
   ...
   public void scroll3colors(int r1, int g1, int b1,int r2, int g2, int b2, int r3, int g3, int b3, int n) {
    ledCounter = getN(1);
    int[] intArray = new int[n];
    for (var i = 0; i < n; i++) {
        intArray[i] =getN(i+1);
